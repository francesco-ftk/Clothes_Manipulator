...
class NewDataSupplier:

    def __init__(self, file_root, img_root_path, dis_feat_root, mode='train'):
    ...
    def get_manipulation_vectors(self, q_id, t_id, distance_between_pair):
        ...
        if len(multi_manip) == distance_between_pair:
